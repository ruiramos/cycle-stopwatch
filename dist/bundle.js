...
/***/ function(module, exports, __webpack_require__) {
	...
	var formatMinutes = function formatMinutes(ms) {
	  return pad2(Math.floor(ms / 1000 / 60 % 60));
	};
	var formatSeconds = function formatSeconds(ms) {
	  return pad2(Math.floor(ms / 1000 % 1000));
	};
	...
	function main(drivers) {
	  ...
	  return {
	    DOM: $actions.map(function (_ref) {
	      ...
	      }, toggleTimerText(isTimerOn)), (0, _dom.button)({
	        type: 'button',
